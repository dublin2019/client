...
export const categoryInfo = {
  ...
  RetroNovella: {
    title: 'Retro Hugo for Best Novella (1943)',
  ...
  RetroNovelette: {
    title: 'Retro Hugo for Best Novelette (1943)',
  ...
  RetroShortStory: {
    title: 'Retro Hugo for Best Short Story (1943)',
  ...
  RetroGraphicStory: {
    title: 'Retro Hugo for Best Graphic Story (1943)',
  ...
  RetroDramaticLong: {
    title: 'Retro Hugo for Best Dramatic Presentation, Long Form (1943)',
  ...
  RetroDramaticShort: {
    title: 'Retro Hugo for Best Dramatic Presentation, Short Form (1943)',
  ...
  RetroEditorShort: {
    title: 'Retro Hugo for Best Professional Editor, Short Form (1943)',
  ...
  RetroEditorLong: {
    title: 'Retro Hugo for Best Professional Editor, Long Form (1943)',
  ...
  RetroProArtist: {
    title: 'Retro Hugo for Best Professional Artist (1943)',
  ...
  RetroSemiprozine: {
    title: 'Retro Hugo for Best Semiprozine (1943)',
  ...
  RetroFanzine: {
    title: 'Retro Hugo for Best Fanzine (1943)',
  ...
  RetroFancast: {
    title: 'Retro Hugo for Best Fancast (1943)',
  ...
  RetroFanWriter: {
    title: 'Retro Hugo for Best Fan Writer (1943)',
  ...
  RetroFanArtist: {
    title: 'Retro Hugo for Best Fan Artist (1943)',
